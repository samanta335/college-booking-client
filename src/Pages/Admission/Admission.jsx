...
const Admission = () => {
  return (
    <div className="grid lg:grid-cols-3 gap-10 my-32">
      ...
      <div className="flex items-center mx-auto ">
        <div className="mask mask-squircle mr-2 w-10 h-12 ">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Columbia_University_shield.svg/1200px-Columbia_University_shield.svg.png"
            alt="Avatar Tailwind CSS Component"
          />
        </div>
        <Link to="/booking" className="underline text-purple-800">
